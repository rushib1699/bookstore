...
import MOCK_DATA from './temp_company_data.json'
import { SetLeftFeature, UserComponentFactory } from 'ag-grid-community'
...
export const GridTable = () => {
    ...
    useEffect(() => {
        setLoading(true);
        Axios.post("http://localhost:3002/allcompanies/fetch")
            .then((response) => {
